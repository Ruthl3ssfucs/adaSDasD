			...
			<!--Where the first picture is put in to display -->
				<div class="left-side">
					...
					<div class="middle-left-box">
						...
						<p class="middle-left-box-text">
							In order for you to establish a full character developing, please direct yourself to www.coolgaming.com and you will see a seperate section of the forum by the name of "Guides".
						</p>
						
						<p class="middle-left-box-text">
							The server was made year 2009 and has been run by the original owner ever since. With distinctive and rewarding management he have built up 10 servers and recruited almost 30 administrators.
						</p>
